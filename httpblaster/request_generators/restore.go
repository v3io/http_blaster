...
func (self *RestoreGenerator) GenerateRequests(global config.Global, wl config.Workload, tls_mode bool, host string, ret_ch chan *Response) chan *Request {
	self.workload = wl
	ch_req := make(chan *Request, 100000)
